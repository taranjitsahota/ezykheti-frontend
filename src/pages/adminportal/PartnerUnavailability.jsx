...
const PartnerUnavailability = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await apiRequest({
        url: `/partner-unavailabilities/${deleteId}`, // Dynamic URL using deleteId
        method: "delete",
      });

      if (response.success) {
        toast.success("Partner Unavailability deleted successfully!");
  ...
  const handleSubmit = async (formdata) => {
    ...
    try {
      ...
      if (response.success) {
        toast.success(
          isEditMode
            ? "Partner Unavailability updated successfully!"
            : "Partner Unavailability created successfully!"
        );
        setDrawerOpen("");
        setIsEditMode(false);
        handleAdminList();
  ...
  const partnerUnavailabilityFormContent = (
    <>
      <TextField
        select
        label="Partner"
  ...
  const partnerUnavailabilityFormContentEdit = (
    <>
      <TextField
        select
        label="Partner"
  ...
  return (
    <DashboardLayout
      pageTitle="Partner Unavailability"
      add="Add Partner Unavailability"
    ...
    >
      ...
      >
        <Anchor
          ...
          formContent={
            drawerOpen === "add"
              ? partnerUnavailabilityFormContent
              : partnerUnavailabilityFormContentEdit
          }
          add={
            drawerOpen === "add"
              ? "Add Partner Unavailability"
              : "Edit Partner Unavailability"
          }
...
export default PartnerUnavailability;
